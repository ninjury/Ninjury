<div id="slider" data-role="navbar">
	<ul>
		...
		<li><a data-ajax="false" data-pjax="true" data-icon="custom" data-iconpos="top" <?php if($page == 'info') echo 'class="ui-btn-active ui-state-persist"'; ?> href="/mobile">INFO</a></li>
		<li><a data-ajax="false" data-pjax="true" data-icon="custom" data-iconpos="top" <?php if($page == 'lists') echo 'class="ui-btn-active ui-state-persist"'; ?> href="/mobile">LISTS</a></li>
	</ul>
</div>
