<div id="slider" data-role="navbar">
	<ul>
		...
		<li><a data-ajax="false" data-icon="custom" data-iconpos="top" id="contact" <?php if($page == 'contact') echo 'class="ui-btn-active ui-state-persist"'; ?> href="/mobile">CONTACT</a></li>
